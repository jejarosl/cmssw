...
#ifndef RecoHGCal_TICL_LinkingAlgoByMLP_H__
#define RecoHGCal_TICL_LinkingAlgoByMLP_H__
...
namespace ticl {
  class LinkingAlgoByMLP final : public LinkingAlgoBase {
  public:
    LinkingAlgoByMLP(const edm::ParameterSet &conf);
    ~LinkingAlgoByMLP() override;
